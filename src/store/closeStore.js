...
import * as api from '@/api/colseStore';
...
class Store {
  ...
  // 列表数据
  @action.bound async regionsPageList(
    params = {
      ...this.pagination,
  ...
  // 地图点位数据
  @action.bound async getSiteLonLat(
    params = {
  ...
  // 修改
  @action.bound async editRegions(params){
    return await api.editRegions(params)
  }
